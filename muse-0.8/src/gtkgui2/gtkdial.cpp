...
gtk_dial_new (GtkAdjustment *adjustment)
{
  ...
  dial = (GtkDial *) gtk_type_new (gtk_dial_get_type ());
			...
			GtkAllocation *allocation)
{
  ...
  dial->radius = (gint) (MIN(allocation->width,allocation->height) * 0.45);
...
*/
  ...
  upper = (gint) dial->adjustment->upper;
  lower = (gint) dial->adjustment->lower;
  ...
  points[0].x = (gint16) (xc + s*dial->pointer_width/2);
  points[0].y = (gint16) (yc + c*dial->pointer_width/2);
  points[1].x = (gint16) (xc + c*dial->radius);
  points[1].y = (gint16) (yc - s*dial->radius);
  points[2].x = (gint16) (xc - s*dial->pointer_width/2);
  points[2].y = (gint16) (yc - c*dial->pointer_width/2);
  points[3].x = (gint16) (xc - c*dial->radius/10);
  points[3].y = (gint16) (yc + s*dial->radius/10);
  ...
  if ((upper - lower) == 0)
    return 123; /* was: return nothing in non-void function */
		       ...
		       GdkEventButton *event)
{
  ...
  dx = (gint) (event->x - widget->allocation.width / 2);
  dy = (gint) (widget->allocation.height / 2 - event->y);
  ...
  if (!dial->button &&
      ...
      (d_parallel > - dial->pointer_width))
    {
      ...
      gtk_dial_update_mouse (dial, (int) event->x, (int) event->y);
    }
